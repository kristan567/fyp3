            ...
            <div class="col-md-10">
                <div class="card borde-0 shadow-lg my-3">
                    <div class="card-header bg-dark">
                        <h3 class="text-white">Edit Equipments</h3>
                    </div>
                    <form enctype="multipart/form-data" action="{{ route('equipments.update',$equipment->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('name', $equipment->name) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    <option value="0" {{ old('type', $equipment->type) == '0' ? 'selected' : '' }}>
                                        Electric</option>
                                    <option value="1" {{ old('type', $equipment->type) == '1' ? 'selected' : '' }}>
                                        Manual</option>
                                    <option value="2" {{ old('type', $equipment->type) == '2' ? 'selected' : '' }}>
                                        Pending</option>
                                    <option value="3" {{ old('type', $equipment->type) == '3' ? 'selected' : '' }}>
                                        Complete</option>
                                </select>
                                @error('type')
                                    <p class="invalid-feedback">{{ $message }}</p>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" cols="30" rows="5">{{ old('description', $equipment->description) }}</textarea>
                                @error('description')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label h5" for="">Availability in (Count) </label>
                                <input value="{{ old('qty', $equipment->qty) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('price', $equipment->price) }}" type="text"
